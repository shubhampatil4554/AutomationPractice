...
public class VtigerLeadsPage extends SeleniumUtility {
	...
	@FindBy(id="include_in_mass_edit_company")
	...
	@FindBy(xpath="//td[@data-name='company']/span/span")
	private WebElement verifyCompany;
	@FindBy(className="searchAndClearButton t-btn-sm btn btn-danger")
	...
	public void sendCompanyName(String companyNameText) {
		typeInput(companyName,companyNameText);
	}
	public String verifyCompanyName() {
		return getTextFromElement(verifyCompany);
	}
}
